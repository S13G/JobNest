...
urlpatterns = [
    ...
    path('employee/create-account', views.EmployeeRegistrationView.as_view(), name="employee-create-account"),
    path('company/create-account', views.CompanyRegistrationView.as_view(), name="company-create-account"),
